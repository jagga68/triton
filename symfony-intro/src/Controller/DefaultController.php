...
class DefaultController extends AbstractController
{
    ...
    public function index()
    {
        ...
        // $entityManager->flush();
        // dump('A new user was saved with the id ' . $user->getId());

        // CRUD READ:
        // $repository = $this->getDoctrine()->getRepository(User::class);
        // $user = $repository->find(1);
        // $user = $repository->findOneBy(['name' => 'Jacek', 'id' => 5]);
        // $user = $repository->findBy(['name' => 'Jacek'], ['id' => 'DESC']);
    ...
    // commented out for further reference
